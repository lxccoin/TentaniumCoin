...
int64 nChainStartTime = 1500488888;
...
const string strMessageMagic = "TentaniumCoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight == 1)
	{
		nSubsidy = 15000000 * COIN;	// 15 million coins, that all pow coins
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in TentaniumCoin
    bool fStrictPayToScriptHash = true; // Always active in TentaniumCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TentaniumCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Theworldissoready";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1500488888;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1608281;
...
if (false && (block.GetHash() != hashGenesisBlock)) {
        ...
        assert(block.hashMerkleRoot == uint256("0x00590042f79da24be47ddfbc73052d1ec82252b4c538d0a9c896024109c4668a"));
